...
class _SearchScreenState extends State<SearchScreen> {
  ...
  TextEditingController tollingDestinationTextEditingController = TextEditingController();
                  ...
                  children: [
                    ...
                    Stack(
                      children: [
                        ...
                        Center(
                          child: Text("Set your towing destination", style: TextStyle(fontSize: 18.0, fontFamily: "San Fransisco"),),
                        ),
                      ],
                    ),
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: TextField(
                                ...
                                controller: tollingDestinationTextEditingController,
                                decoration: InputDecoration(
...
class PredictionTile extends StatelessWidget
{
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 8.0,),
                        Text(placePredictions!.main_text != null? placePredictions!.main_text! : "", overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16.0),),
                        SizedBox(height: 2.0,),
                        Text(placePredictions!.secondary_text != null?placePredictions!.secondary_text! : "", overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 12.0, color: Colors.grey),),
                        SizedBox(height: 8.0,),
                      ],
                    ),
                  ),
  ...
  void getPlaceAddressDetails(String placeId, context) async
  {
    showDialog(
      context: context,
      builder: (BuildContext context) => ProgressDialog(message: "Setting toll destination, Please wait...",)
    );
