...
class Singleservice
{
  ...
  Singleservice({this.id, this.driver_id, this.truck_description, this.towing_capacity, this.towing_fee, this.location_latitude, this.location_longitude, this.status});

  Singleservice.fromSnapshot(DataSnapshot dataSnapshot)
  {
    id = dataSnapshot.key;
